...
from midaa.Encoder import *
from midaa.Decoder import *
from midaa.Utils import *
from midaa.Likelihood import *
from midaa.Utils_guide import compute_auxiliary_params_guide


class MIDAA(nn.Module):
    def __init__(self,
        n_dim_input, 
        input_types,
